...
import br.com.postech.soat.payment.application.ReprocessPendingPaymentsService;
...
class ReprocessPendingPaymentsServiceTest {
    ...
    @InjectMocks
    private ReprocessPendingPaymentsService reprocessPendingPaymentsService;
    ...
    void shouldReprocessPendingPaymentsSuccessfullyWhenGatewayReturnsSuccess() {
        ...
        reprocessPendingPaymentsService.reprocess();
